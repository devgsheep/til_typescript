...
```json
{
  ...
  "compilerOptions": {
    ...
    "strictNullChecks": false // 여기서 null값 허용
  }
}
```
...
## 9. 기본형 데이터 종류 정리(javaScript에도 존재)
...
## 10. 오로지 TypeScript에만 존재하는 데이터 타입
...
1. 대문자로 시작
2. 새로운 단어는 대문자로 시작
3. 의미가 다름. 관례상(개발자간의 암묵적 약속)
- 객체 아닐까?
- 객체를 만드는 객체생성자 함수 아닐까?
- 객체를 생성하는 클래스 아닐까?

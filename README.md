...
- 이미 만들어둔 `type을 더 쉽게 사용`하는 도구
- 기존 유명 ts 라이브러리 분석 및 활용에 도움이 됨.
- 경험이 쌓이면 자주 활용하는 문법

## 1. Partial<T>

- 모든 속성을 ?로변환함(Optional) : 선택적 속성
...
jimin.fontSize = 40; // Error. 읽기 전용, 변경 불가능
```
